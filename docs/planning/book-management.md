...
- Связанные данные:
  ...
  - Страницы (pages) - **отображаются с возможностью просмотра: главная картинка слева крупно, миниатюры справа**
  - Отзывы (reviews)
  - Даты прочтения (reading_dates)
  - Хэштеги (hashtags)

**Отображение страниц:**
- Главная картинка (первая страница или выбранная) отображается слева вверху, крупно, почти на всю ширину окна
- Справа от главной картинки - вертикальный список миниатюр всех страниц
- При клике на миниатюру - она заменяет главную картинку в крупном окне
- Если страниц нет - секция не отображается
