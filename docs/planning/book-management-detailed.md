...
5. ⚠️ Реализовать управление изображениями (добавление/удаление) - API endpoint готов, UI не реализован
6. ⚠️ Реализовать управление электронными версиями (добавление/удаление) - удаление реализовано, добавление не реализовано
7. ✅ Реализовать управление страницами (просмотр/добавление/удаление)
...
11. ✅ Исправить проблему с автоматическим показом списка автодополнения в PublisherAutocomplete
12. Примечание: отзывы на книгу редактируются отдельно через BookDetailModal (не через BookEditModal)
...
- [ ] Добавление изображений работает (не реализовано)
- [ ] Удаление изображений работает (с подтверждением через ConfirmModal) (API endpoint готов, UI не реализован)
- [ ] Добавление электронных версий работает (не реализовано)
- [x] Удаление электронных версий работает (с подтверждением через ConfirmModal)
- [x] Добавление страниц работает
- [x] Удаление страниц работает (с подтверждением через ConfirmModal)
...
4. ✅ Улучшена обработка данных:
   ...
   - `cover_page_index` удаляется, если нет изображений
