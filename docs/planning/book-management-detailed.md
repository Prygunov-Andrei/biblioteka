...
12. Реализовать валидацию формы (только title обязателен)
13. Добавить кнопки "Назад" и "Далее"
...
10. Примечание: отзывы на книгу редактируются отдельно через BookDetailModal (не через BookEditModal)
